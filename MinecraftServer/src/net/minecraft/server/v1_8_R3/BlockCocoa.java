...
public class BlockCocoa extends BlockDirectional implements IBlockFragilePlantElement {
    ...
    public void b(World world, BlockPosition blockposition, IBlockData iblockdata, Random random) {
        if (!this.e(world, blockposition, iblockdata)) {
            ...
            if (i < 2) {
                IBlockData iblockdata1 = iblockdata.set(BlockCocoa.AGE, Integer.valueOf(i + 1));
    ...
    public void b(World world, Random random, BlockPosition blockposition, IBlockData iblockdata) {
        IBlockData iblockdata1 = iblockdata.set(BlockCocoa.AGE, Integer.valueOf(((Integer) iblockdata.get(BlockCocoa.AGE)).intValue() + 1));
