...
public class BlockCrops extends BlockPlant implements IBlockFragilePlantElement {
    ...
    public void b(World world, BlockPosition blockposition, IBlockData iblockdata, Random random) {
        ...
        if (world.getLightLevel(blockposition.up()) >= 9) {
            ...
            if (i < 7) {
                ...
                if (random.nextInt((int) (world.growthOdds / (float) world.spigotConfig.wheatModifier * (25.0F / f)) + 1) == 0) {
                    IBlockData iblockdata1 = iblockdata.set(BlockCrops.AGE, Integer.valueOf(i + 1));

                    CraftEventFactory.handleBlockGrowEvent(world, blockposition.getX(), blockposition.getY(), blockposition.getZ(), this, this.toLegacyData(iblockdata1));
                }
            }
        }
    ...
    public void g(World world, BlockPosition blockposition, IBlockData iblockdata) {
        ...
        IBlockData iblockdata1 = iblockdata.set(BlockCrops.AGE, Integer.valueOf(i));
