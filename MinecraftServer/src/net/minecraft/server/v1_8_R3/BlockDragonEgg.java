        ...
        if (iblockdata.getBlock() == this) {
            for (int i = 0; i < 1000; ++i) {
                ...
                if (world.getType(blockposition1).getBlock().material == Material.AIR) {
                    ...
                    BlockFromToEvent blockfromtoevent = new BlockFromToEvent(org_bukkit_block_block, org_bukkit_block_block1);
                    ...
                    blockposition1 = new BlockPosition(blockfromtoevent.getToBlock().getX(), blockfromtoevent.getToBlock().getY(), blockfromtoevent.getToBlock().getZ());
