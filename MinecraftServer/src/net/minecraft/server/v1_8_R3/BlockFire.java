...
public class BlockFire extends Block {
                            ...
                            if (j != 0 || l != 0 || k != 0) {
                                ...
                                if (j1 > 0) {
                                    ...
                                    if (k1 > 0 && random.nextInt(i1) <= k1 && (!world.S() || !this.e(world, blockposition1))) {
                                        ...
                                        if (world.getType(blockposition1) != Blocks.FIRE && !CraftEventFactory.callBlockIgniteEvent(world, blockposition1.getX(), blockposition1.getY(), blockposition1.getZ(), blockposition.getX(), blockposition.getY(), blockposition.getZ()).isCancelled()) {
                                            ...
                                            org_bukkit_block_blockstate.setTypeId(Block.getId(this));
                                            org_bukkit_block_blockstate.setData(new MaterialData(Block.getId(this), (byte) l1));
                                            BlockSpreadEvent blockspreadevent = new BlockSpreadEvent(org_bukkit_block_blockstate.getBlock(), craftworld.getBlockAt(blockposition.getX(), blockposition.getY(), blockposition.getZ()), org_bukkit_block_blockstate);

                                            craftserver.getPluginManager().callEvent(blockspreadevent);
    ...
    private void a(World world, BlockPosition blockposition, int i, Random random, int j) {
        ...
        if (random.nextInt(i) < k) {
            ...
            BlockBurnEvent blockburnevent = new BlockBurnEvent(org_bukkit_block_block);
