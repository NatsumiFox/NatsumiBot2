...
public class BlockIce extends BlockHalfTransparent {
    ...
    public void b(World world, BlockPosition blockposition, IBlockData iblockdata, Random random) {
        if (world.b(EnumSkyBlock.BLOCK, blockposition) > 11 - this.p()) {
            if (CraftEventFactory.callBlockFadeEvent(world.getWorld().getBlockAt(blockposition.getX(), blockposition.getY(), blockposition.getZ()), (Block) (world.worldProvider.n() ? Blocks.AIR : Blocks.WATER)).isCancelled()) {
                return;
            }
