...
public class BlockMonsterEggs extends Block {
    ...
    public IBlockData d() {
        ...
        EnumMonsterEggVarient(int i, String s, BlockMonsterEggs.EnumMonsterEggVarient blockmonstereggs_enummonstereggvarient) {
            this(i, s);
        }

        EnumMonsterEggVarient(int i, String s, String s1, BlockMonsterEggs.EnumMonsterEggVarient blockmonstereggs_enummonstereggvarient) {
            this(i, s, s1);
        }
    }
