...
public class BlockPortal extends BlockHalfTransparent {
    ...
    public void b(World world, BlockPosition blockposition, IBlockData iblockdata, Random random) {
        ...
        if (world.spigotConfig.enableZombiePigmenPortalSpawns && world.worldProvider.d() && world.getGameRules().getBoolean("doMobSpawning") && random.nextInt(2000) < world.getDifficulty().a()) {
            ...
            if (i > 0 && !world.getType(blockposition1.up()).getBlock().isOccluding()) {
                Entity entity = ItemMonsterEgg.spawnCreature(world, 57, (double) blockposition1.getX() + 0.5D, (double) blockposition1.getY() + 1.1D, (double) blockposition1.getZ() + 0.5D, SpawnReason.NETHER_PORTAL);
    ...
    public boolean e(World world, BlockPosition blockposition) {
        ...
        if (blockportal_shape.d() && blockportal_shape.e == 0) {
            ...
            return blockportal_shape1.d() && blockportal_shape1.e == 0 ? blockportal_shape1.e() : false;
        }
    }
    ...
    public void a(World world, BlockPosition blockposition, IBlockData iblockdata, Entity entity) {
        if (entity.vehicle == null && entity.passenger == null) {
            EntityPortalEnterEvent entityportalenterevent = new EntityPortalEnterEvent(entity.getBukkitEntity(), new Location(world.getWorld(), (double) blockposition.getX(), (double) blockposition.getY(), (double) blockposition.getZ()));

            world.getServer().getPluginManager().callEvent(entityportalenterevent);
    ...
    public ShapeDetector.ShapeDetectorCollection f(World world, BlockPosition blockposition) {
        ...
        if (!blockportal_shape.d()) {
            ...
            for (j = 0; j < i; ++j) {
                enumdirection_enumaxisdirection = aenumdirection_enumaxisdirection[j];
                ...
                for (k = 0; k < blockportal_shape.b(); ++k) {
            ...
            enumdirection_enumaxisdirection = EnumDirection.EnumAxisDirection.POSITIVE;
            ...
            for (k = 0; k < j; ++k) {
                EnumDirection.EnumAxisDirection enumdirection_enumaxisdirection1 = aenumdirection_enumaxisdirection1[k];

                if (aint[enumdirection_enumaxisdirection1.ordinal()] < aint[enumdirection_enumaxisdirection.ordinal()]) {
                    enumdirection_enumaxisdirection = enumdirection_enumaxisdirection1;
                }
            }

            return new ShapeDetector.ShapeDetectorCollection(enumdirection.c() == enumdirection_enumaxisdirection ? blockposition1 : blockposition1.shift(blockportal_shape.c, blockportal_shape.b() - 1), EnumDirection.a(enumdirection_enumaxisdirection, enumdirection_enumaxis), EnumDirection.UP, loadingcache, blockportal_shape.b(), blockportal_shape.a(), 1);
        }
    }
    ...
    public static class Shape {
        ...
        protected int c() {
            this.blocks.clear();
            CraftWorld craftworld = this.a.getWorld();
            ...
            for (this.g = 0; this.g < 21; ++this.g) {
                for (i = 0; i < this.h; ++i) {
                    blockposition = this.f.shift(this.c, i).up(this.g);
                    ...
                    if (i == 0) {
                        ...
                        blockposition1 = blockposition.shift(this.d);
                        this.blocks.add(craftworld.getBlockAt(blockposition1.getX(), blockposition1.getY(), blockposition1.getZ()));
                    } else if (i == this.h - 1) {
                        ...
                        blockposition1 = blockposition.shift(this.c);
                        this.blocks.add(craftworld.getBlockAt(blockposition1.getX(), blockposition1.getY(), blockposition1.getZ()));
                    }
                }
            }
            ...
            for (i = 0; i < this.h; ++i) {
                ...
                blockposition = this.f.shift(this.c, i).up(this.g);
                this.blocks.add(craftworld.getBlockAt(blockposition.getX(), blockposition.getY(), blockposition.getZ()));
            }
        ...
        public boolean e() {
            ...
            PortalCreateEvent portalcreateevent = new PortalCreateEvent(this.blocks, craftworld, CreateReason.FIRE);
            ...
            if (portalcreateevent.isCancelled()) {
                ...
                for (int k = 0; k < this.h; ++k) {
                    BlockPosition blockposition2 = this.f.shift(this.c, k);
