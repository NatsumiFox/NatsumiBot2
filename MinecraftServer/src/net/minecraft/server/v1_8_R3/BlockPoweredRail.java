...
public class BlockPoweredRail extends BlockMinecartTrackAbstract {
    ...
    protected void b(World world, BlockPosition blockposition, IBlockData iblockdata, Block block) {
        ...
        if (flag1 != flag) {
            int i = ((Boolean) iblockdata.get(BlockPoweredRail.POWERED)).booleanValue() ? 15 : 0;
            int j = CraftEventFactory.callRedstoneChange(world, blockposition.getX(), blockposition.getY(), blockposition.getZ(), i, 15 - i).getNewCurrent();
