    ...
    public void b(World world, BlockPosition blockposition, IBlockData iblockdata, Random random) {
        ...
        if (this.isOn) {
            if (flag) {
                ...
                world.setTypeAndData(blockposition, Blocks.UNLIT_REDSTONE_TORCH.getBlockData().set(BlockRedstoneTorch.FACING, (EnumDirection) iblockdata.get(BlockRedstoneTorch.FACING)), 3);
            ...
            world.setTypeAndData(blockposition, Blocks.REDSTONE_TORCH.getBlockData().set(BlockRedstoneTorch.FACING, (EnumDirection) iblockdata.get(BlockRedstoneTorch.FACING)), 3);
        }
