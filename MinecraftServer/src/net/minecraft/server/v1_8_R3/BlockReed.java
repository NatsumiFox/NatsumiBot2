...
public class BlockReed extends Block {
    ...
    public void b(World world, BlockPosition blockposition, IBlockData iblockdata, Random random) {
        if ((world.getType(blockposition.down()).getBlock() == Blocks.REEDS || this.e(world, blockposition, iblockdata)) && world.isEmpty(blockposition.up())) {
            int i;
            ...
            if (i < 3) {
                ...
                if (j >= (byte) ((int) range(3.0F, world.growthOdds / (float) world.spigotConfig.caneModifier * 15.0F + 0.5F, 15.0F))) {
    ...
    public boolean canPlace(World world, BlockPosition blockposition) {
        ...
        if (block == this) {
            ...
            while (iterator.hasNext()) {
                ...
                if (world.getType(blockposition.shift(enumdirection).down()).getBlock().getMaterial() == Material.WATER) {
                    return true;
                }
            }
