...
public class BlockSoil extends Block {
    ...
    public void b(World world, BlockPosition blockposition, IBlockData iblockdata, Random random) {
        ...
        if (!this.f(world, blockposition) && !world.isRainingAt(blockposition.up())) {
            if (i > 0) {
                ...
                if (CraftEventFactory.callBlockFadeEvent(org_bukkit_block_block, Blocks.DIRT).isCancelled()) {
                    return;
                }
    ...
    public void a(World world, BlockPosition blockposition, Entity entity, float f) {
        ...
        if (entity instanceof EntityLiving && !world.isClientSide && world.random.nextFloat() < f - 0.5F) {
    ...
    private boolean f(World world, BlockPosition blockposition) {
        ...
        while (iterator.hasNext()) {
            ...
            if (world.getType(blockposition_mutableblockposition).getBlock().getMaterial() == Material.WATER) {
                return true;
            }
        }
