...
public class BlockTripwire extends Block {
    ...
    public void a(World world, BlockPosition blockposition, IBlockData iblockdata, Entity entity) {
        if (!world.isClientSide && !((Boolean) iblockdata.get(BlockTripwire.POWERED)).booleanValue()) {
    ...
    public void b(World world, BlockPosition blockposition, IBlockData iblockdata, Random random) {
        if (!world.isClientSide && ((Boolean) world.getType(blockposition).get(BlockTripwire.POWERED)).booleanValue()) {
            this.e(world, blockposition);
        }
    ...
    private void e(World world, BlockPosition blockposition) {
        ...
        if (flag != flag1 && flag1 && ((Boolean) iblockdata.get(BlockTripwire.ATTACHED)).booleanValue()) {
            ...
            while (iterator1.hasNext()) {
                ...
                if (object != null) {
                    ...
                    if (object instanceof EntityHuman) {
                        object1 = CraftEventFactory.callPlayerInteractEvent((EntityHuman) object, Action.PHYSICAL, blockposition, (EnumDirection) null, (ItemStack) null);
                    } else {
                        if (!(object instanceof Entity)) {
                            continue;
                        }

                        object1 = new EntityInteractEvent(((Entity) object).getBukkitEntity(), org_bukkit_block_block);
                        pluginmanager.callEvent((EntityInteractEvent) object1);
                    }

                    if (!((Cancellable) object1).isCancelled()) {
                        flag2 = true;
                        break;
                    }
                }
