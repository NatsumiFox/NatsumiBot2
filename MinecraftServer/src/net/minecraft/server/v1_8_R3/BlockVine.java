            ...
            if (enumdirection == EnumDirection.UP && blockposition.getY() < 255 && world.isEmpty(blockposition1)) {
                if (!flag) {
                    ...
                    if (((Boolean) iblockdata1.get(BlockVine.NORTH)).booleanValue() || ((Boolean) iblockdata1.get(BlockVine.EAST)).booleanValue() || ((Boolean) iblockdata1.get(BlockVine.SOUTH)).booleanValue() || ((Boolean) iblockdata1.get(BlockVine.WEST)).booleanValue()) {
                        ...
                        org.bukkit.block.Block org_bukkit_block_block1 = world.getWorld().getBlockAt(blockposition1.getX(), blockposition1.getY(), blockposition1.getZ());

                        CraftEventFactory.handleBlockSpreadEvent(org_bukkit_block_block1, org_bukkit_block_block, this, this.toLegacyData(iblockdata1));
                    }
                }
            } else {
                BlockPosition blockposition2;
                org.bukkit.block.Block org_bukkit_block_block2;
                ...
                if (enumdirection.k().c() && !((Boolean) iblockdata.get(a(enumdirection))).booleanValue()) {
                    if (!flag) {
                        ...
                        if (block.material == Material.AIR) {
                            ...
                            org_bukkit_block_block2 = world.getWorld().getBlockAt(blockposition.getX(), blockposition.getY(), blockposition.getZ());
                            org.bukkit.block.Block org_bukkit_block_block3 = world.getWorld().getBlockAt(blockposition1.getX(), blockposition1.getY(), blockposition1.getZ());

                            if (flag1 && this.c(world.getType(blockposition3).getBlock())) {
                                CraftEventFactory.handleBlockSpreadEvent(org_bukkit_block_block3, org_bukkit_block_block2, this, this.toLegacyData(this.getBlockData().set(a(enumdirection1), Boolean.valueOf(true))));
                            } else if (flag2 && this.c(world.getType(blockposition4).getBlock())) {
                                CraftEventFactory.handleBlockSpreadEvent(org_bukkit_block_block3, org_bukkit_block_block2, this, this.toLegacyData(this.getBlockData().set(a(enumdirection2), Boolean.valueOf(true))));
                            } else if (flag1 && world.isEmpty(blockposition3) && this.c(world.getType(blockposition.shift(enumdirection1)).getBlock())) {
                                org_bukkit_block_block3 = world.getWorld().getBlockAt(blockposition3.getX(), blockposition3.getY(), blockposition3.getZ());
                                CraftEventFactory.handleBlockSpreadEvent(org_bukkit_block_block3, org_bukkit_block_block2, this, this.toLegacyData(this.getBlockData().set(a(enumdirection.opposite()), Boolean.valueOf(true))));
                            } else if (flag2 && world.isEmpty(blockposition4) && this.c(world.getType(blockposition.shift(enumdirection2)).getBlock())) {
                                org_bukkit_block_block3 = world.getWorld().getBlockAt(blockposition4.getX(), blockposition4.getY(), blockposition4.getZ());
                                CraftEventFactory.handleBlockSpreadEvent(org_bukkit_block_block3, org_bukkit_block_block2, this, this.toLegacyData(this.getBlockData().set(a(enumdirection.opposite()), Boolean.valueOf(true))));
                            } else if (this.c(world.getType(blockposition2.up()).getBlock())) {
                                CraftEventFactory.handleBlockSpreadEvent(org_bukkit_block_block3, org_bukkit_block_block2, this, this.toLegacyData(this.getBlockData()));
                            }
                    ...
                    if (block1.material == Material.AIR) {
                        ...
                        if (((Boolean) iblockdata3.get(BlockVine.NORTH)).booleanValue() || ((Boolean) iblockdata3.get(BlockVine.EAST)).booleanValue() || ((Boolean) iblockdata3.get(BlockVine.SOUTH)).booleanValue() || ((Boolean) iblockdata3.get(BlockVine.WEST)).booleanValue()) {
                            org.bukkit.block.Block org_bukkit_block_block4 = world.getWorld().getBlockAt(blockposition.getX(), blockposition.getY(), blockposition.getZ());

                            org_bukkit_block_block2 = world.getWorld().getBlockAt(blockposition2.getX(), blockposition2.getY(), blockposition2.getZ());
                            CraftEventFactory.handleBlockSpreadEvent(org_bukkit_block_block2, org_bukkit_block_block4, this, this.toLegacyData(iblockdata3));
                        }
                    } else if (block1 == this) {
