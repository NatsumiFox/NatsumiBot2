...
public class Chunk {
    ...
    public void setNeighborLoaded(int i, int j) {
        this.neighbors |= 1 << i * 5 + 12 + j;
    }

    public void setNeighborUnloaded(int i, int j) {
        this.neighbors &= ~(1 << i * 5 + 12 + j);
    }
    ...
    public void a(Entity entity) {
        ...
        int l = (aenumcreaturetype = EnumCreatureType.values()).length;
    ...
    public void a(Entity entity, int i) {
        ...
        EnumCreatureType[] aenumcreaturetype;
        int j = (aenumcreaturetype = EnumCreatureType.values()).length;
    ...
    public void a(BlockPosition blockposition, TileEntity tileentity) {
        ...
        if (this.getType(blockposition) instanceof IContainer) {
            ...
            System.out.println("Attempted to place a tile entity (" + tileentity + ") at " + tileentity.position.getX() + "," + tileentity.position.getY() + "," + tileentity.position.getZ() + " (" + CraftMagicNumbers.getMaterial(this.getType(blockposition)) + ") where there was no entity tile!");
    ...
    public void removeEntities() {
        ...
        for (Iterator iterator1 = this.tileEntities.values().iterator(); iterator1.hasNext(); this.world.b(tileentity)) {
            tileentity = (TileEntity) iterator1.next();
            if (tileentity instanceof IInventory) {
                iterator = Lists.newArrayList(((IInventory) tileentity).getViewers()).iterator();
        ...
        for (int i = 0; i < this.entitySlices.length; ++i) {
            ArrayList arraylist = Lists.newArrayList(this.entitySlices[i]);
            ...
            while (iterator.hasNext()) {
                ...
                if (entity instanceof IInventory) {
                    Iterator iterator2 = Lists.newArrayList(((IInventory) entity).getViewers()).iterator();

                    while (iterator2.hasNext()) {
                        HumanEntity humanentity1 = (HumanEntity) iterator2.next();
            ...
            this.world.c((Collection) arraylist);
        }
