...
class CommandExecute$CommandListenerEntity implements ICommandListener {
    ...
    CommandExecute$CommandListenerEntity(CommandExecute commandexecute, Entity entity, ICommandListener icommandlistener, BlockPosition blockposition, double d0, double d1, double d2) {
