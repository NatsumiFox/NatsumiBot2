        ...
        if (astring.length < 5) {
            ...
            try {
                ...
                if (icommandlistener instanceof DedicatedServer) {
                    object = MinecraftServer.getServer().server.getConsoleSender();
                } else if (icommandlistener instanceof CommandBlockListenerAbstract) {
                    object = ((CommandBlockListenerAbstract) icommandlistener).sender;
                } else if (VanillaCommandWrapper.lastSender != null) {
                    object = VanillaCommandWrapper.lastSender;
                } else {
                    ...
                    object = icommandlistener.f().getBukkitEntity();
                }

                int j = CommandBlockListenerAbstract.executeCommand(icommandlistener1, new ProxiedNativeCommandSender(icommandlistener1, (CommandSender) object, entity.getBukkitEntity()), s);
