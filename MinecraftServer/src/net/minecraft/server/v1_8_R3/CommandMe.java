...
public class CommandMe extends CommandAbstract {
    ...
    public void execute(ICommandListener icommandlistener, String[] astring) throws CommandException {
        if (astring.length <= 0) {
            ...
            MinecraftServer.getServer().getPlayerList().sendMessage((IChatBaseComponent) (new ChatMessage("chat.type.emote", new Object[] { icommandlistener.getScoreboardDisplayName(), ichatbasecomponent})));
        }
    }
