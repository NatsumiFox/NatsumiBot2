...
public class CommandSay extends CommandAbstract {
    ...
    public void execute(ICommandListener icommandlistener, String[] astring) throws CommandException {
        if (astring.length > 0 && astring[0].length() > 0) {
            ...
            MinecraftServer.getServer().getPlayerList().sendMessage((IChatBaseComponent) (new ChatMessage("chat.type.announcement", new Object[] { icommandlistener.getScoreboardDisplayName(), ichatbasecomponent})));
        } else {
