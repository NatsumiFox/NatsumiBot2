    ...
    static class Location2D {
        ...
        public int a(World world) {
            ...
            while (blockposition.getY() > 0) {
                ...
                if (getType(world, blockposition).getBlock().getMaterial() != Material.AIR) {
        ...
        public boolean b(World world) {
            ...
            while (blockposition.getY() > 0) {
                blockposition = blockposition.down();
                Material material = getType(world, blockposition).getBlock().getMaterial();
        ...
        private static IBlockData getType(World world, BlockPosition blockposition) {
