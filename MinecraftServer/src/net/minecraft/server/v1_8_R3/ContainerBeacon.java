...
public class ContainerBeacon extends Container {
    ...
    public boolean a(EntityHuman entityhuman) {
        return !this.checkReachable ? true : this.a.a(entityhuman);
    }
    ...
    public CraftInventoryView getBukkitView() {
        if (this.bukkitEntity != null) {
            ...
            CraftInventoryBeacon craftinventorybeacon = new CraftInventoryBeacon((TileEntityBeacon) this.a);

            this.bukkitEntity = new CraftInventoryView(this.player.player.getBukkitEntity(), craftinventorybeacon, this);
            return this.bukkitEntity;
        }
    }
