...
public class EntityArmorStand extends EntityLiving {
    ...
    public boolean a(EntityHuman entityhuman, Vec3D vec3d) {
        if (this.s()) {
            ...
            double d0 = flag1 ? vec3d.b * 2.0D : vec3d.b;
    ...
    private void a(EntityHuman entityhuman, int i) {
        ...
        if ((itemstack == null || (this.bi & 1 << i + 8) == 0) && (itemstack != null || (this.bi & 1 << i + 16) == 0)) {
            ...
            CraftItemStack craftitemstack1 = CraftItemStack.asCraftMirror(itemstack1);
            Player player = (Player) entityhuman.getBukkitEntity();
            ArmorStand armorstand = (ArmorStand) this.getBukkitEntity();
            EquipmentSlot equipmentslot = CraftEquipmentSlot.getSlot(i);
            PlayerArmorStandManipulateEvent playerarmorstandmanipulateevent = new PlayerArmorStandManipulateEvent(player, armorstand, craftitemstack1, craftitemstack, equipmentslot);
