    ...
    public void d(EntityHuman entityhuman) {
        if (!this.world.isClientSide && this.inGround && this.shake <= 0) {
            ...
            if (this.fromPlayer == 1 && entityhuman.inventory.canHold(itemstack) > 0) {
                ...
                PlayerPickupItemEvent playerpickupitemevent = new PlayerPickupItemEvent((Player) entityhuman.getBukkitEntity(), new CraftItem(this.world.getServer(), this, entityitem), 0);
