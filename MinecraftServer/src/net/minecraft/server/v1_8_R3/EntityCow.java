...
public class EntityCow extends EntityAnimal {
    ...
    public boolean a(EntityHuman entityhuman) {
        ...
        if (itemstack != null && itemstack.getItem() == Items.BUCKET && !entityhuman.abilities.canInstantlyBuild && !this.isBaby()) {
            ...
            PlayerBucketFillEvent playerbucketfillevent = CraftEventFactory.callPlayerBucketFillEvent(entityhuman, location.getBlockX(), location.getBlockY(), location.getBlockZ(), (EnumDirection) null, itemstack, Items.MILK_BUCKET);
