...
public class EntityEnderman extends EntityMonster {
    ...
    protected boolean k(double d0, double d1, double d2) {
        ...
        if (this.world.isLoaded(blockposition)) {
            ...
            if (flag1) {
                EntityTeleportEvent entityteleportevent = new EntityTeleportEvent(this.getBukkitEntity(), new Location(this.world.getWorld(), d3, d4, d5), new Location(this.world.getWorld(), this.locX, this.locY, this.locZ));
    ...
    static class PathfinderGoalEndermanPickupBlock extends PathfinderGoal {
        ...
        public void e() {
            ...
            if (EntityEnderman.c.contains(block) && !CraftEventFactory.callEntityChangeBlockEvent(this.enderman, this.enderman.world.getWorld().getBlockAt(blockposition.getX(), blockposition.getY(), blockposition.getZ()), org.bukkit.Material.AIR).isCancelled()) {
