...
public class EntityFishingHook extends Entity {
    ...
    public int l() {
        if (this.world.isClientSide) {
            ...
            if (this.hooked != null) {
                playerfishevent = new PlayerFishEvent((Player) this.owner.getBukkitEntity(), this.hooked.getBukkitEntity(), (Fish) this.getBukkitEntity(), State.CAUGHT_ENTITY);
            ...
            if (this.as) {
                playerfishevent = new PlayerFishEvent((Player) this.owner.getBukkitEntity(), (org.bukkit.entity.Entity) null, (Fish) this.getBukkitEntity(), State.IN_GROUND);
                this.world.getServer().getPluginManager().callEvent(playerfishevent);
                if (playerfishevent.isCancelled()) {
                    return 0;
                }
            ...
            if (b0 == 0) {
                playerfishevent = new PlayerFishEvent((Player) this.owner.getBukkitEntity(), (org.bukkit.entity.Entity) null, (Fish) this.getBukkitEntity(), State.FAILED_ATTEMPT);
                this.world.getServer().getPluginManager().callEvent(playerfishevent);
                if (playerfishevent.isCancelled()) {
                    return 0;
                }
