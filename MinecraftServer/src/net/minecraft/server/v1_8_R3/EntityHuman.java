...
public abstract class EntityHuman extends EntityLiving {
    ...
    protected void s() {
        if (this.g != null) {
            this.b(this.g, 16);
            int i = this.g.count;
            org.bukkit.inventory.ItemStack org_bukkit_inventory_itemstack = CraftItemStack.asBukkitCopy(this.g);
            PlayerItemConsumeEvent playeritemconsumeevent = new PlayerItemConsumeEvent((Player) this.getBukkitEntity(), org_bukkit_inventory_itemstack);
            ...
            if (!org_bukkit_inventory_itemstack.equals(playeritemconsumeevent.getItem())) {
    ...
    public void b(Entity entity, int i) {
        this.addScore(i);
        Collection collection = this.world.getServer().getScoreboardManager().getScoreboardScores(IScoreboardCriteria.f, this.getName(), new ArrayList());
    ...
    public EntityItem a(ItemStack itemstack, boolean flag, boolean flag1) {
        if (itemstack == null) {
            ...
            if (!playerdropitemevent.isCancelled()) {
                ...
                org.bukkit.inventory.ItemStack org_bukkit_inventory_itemstack = player.getInventory().getItemInHand();

                if (flag1 && (org_bukkit_inventory_itemstack == null || org_bukkit_inventory_itemstack.getAmount() == 0)) {
                    player.getInventory().setItemInHand(craftitem.getItemStack());
                } else if (flag1 && org_bukkit_inventory_itemstack.isSimilar(craftitem.getItemStack()) && craftitem.getItemStack().getAmount() == 1) {
                    org_bukkit_inventory_itemstack.setAmount(org_bukkit_inventory_itemstack.getAmount() + 1);
                    player.getInventory().setItemInHand(org_bukkit_inventory_itemstack);
                } else {
    ...
    public boolean a(EntityHuman entityhuman) {
        ...
        if (entityhuman instanceof EntityPlayer) {
            ...
            OfflinePlayer offlineplayer = entityhuman.world.getServer().getOfflinePlayer(entityhuman.getName());

            team = entityhuman.world.getServer().getScoreboardManager().getMainScoreboard().getPlayerTeam(offlineplayer);
            if (team == null || team.allowFriendlyFire()) {
                return true;
            }
        }

        return this instanceof EntityPlayer ? !team.hasPlayer(((EntityPlayer) this).getBukkitEntity()) : !team.hasPlayer(this.world.getServer().getOfflinePlayer(this.getName()));
    }
        ...
        if (entity.aD() && !entity.l(this)) {
            ...
            if (f > 0.0F || f1 > 0.0F) {
                ...
                if (entity instanceof EntityLiving && j > 0 && !entity.isBurning()) {
                    EntityCombustByEntityEvent entitycombustbyentityevent = new EntityCombustByEntityEvent(this.getBukkitEntity(), entity.getBukkitEntity(), 1);
                ...
                if (flag2) {
                    ...
                    if (entity instanceof EntityLiving) {
                        ...
                        if (j > 0) {
                            EntityCombustByEntityEvent entitycombustbyentityevent1 = new EntityCombustByEntityEvent(this.getBukkitEntity(), entity.getBukkitEntity(), j * 4);

                            Bukkit.getPluginManager().callEvent(entitycombustbyentityevent1);
                            if (!entitycombustbyentityevent1.isCancelled()) {
                                entity.setOnFire(entitycombustbyentityevent1.getDuration());
                            }
                        }
                    }
    ...
    public EntityHuman.EnumBedResult a(BlockPosition blockposition) {
        ...
        if (this.getBukkitEntity() instanceof Player) {
            ...
            PlayerBedEnterEvent playerbedenterevent = new PlayerBedEnterEvent(player, org_bukkit_block_block);
    ...
    public void a(boolean flag, boolean flag1, boolean flag2) {
        ...
        if (this.getBukkitEntity() instanceof Player) {
            ...
            if (blockposition1 != null) {
                org_bukkit_block_block = this.world.getWorld().getBlockAt(blockposition1.getX(), blockposition1.getY(), blockposition1.getZ());
            } else {
                org_bukkit_block_block = this.world.getWorld().getBlockAt(player.getLocation());
            }

            PlayerBedLeaveEvent playerbedleaveevent = new PlayerBedLeaveEvent(player, org_bukkit_block_block);
