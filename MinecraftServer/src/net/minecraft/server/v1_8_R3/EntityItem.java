...
public class EntityItem extends Entity {
    ...
    private void w() {
        ...
        Iterator iterator = this.world.a(EntityItem.class, this.getBoundingBox().grow(d0, d0, d0)).iterator();
    ...
    public void d(EntityHuman entityhuman) {
        if (!this.world.isClientSide) {
            ...
            int j = entityhuman.inventory.canHold(itemstack);
            int k = itemstack.count - j;

            if (this.pickupDelay <= 0 && j > 0) {
                itemstack.count = j;
                PlayerPickupItemEvent playerpickupitemevent = new PlayerPickupItemEvent((Player) entityhuman.getBukkitEntity(), (org.bukkit.entity.Item) this.getBukkitEntity(), k);
