        ...
        if (movingobjectposition == null) {
            ...
            if (flag) {
                ...
                if (movingobjectposition.type == MovingObjectPosition.EnumMovingObjectType.BLOCK) {
                    ...
                    PlayerInteractEvent playerinteractevent = CraftEventFactory.callPlayerInteractEvent(entityhuman, Action.RIGHT_CLICK_BLOCK, blockposition, movingobjectposition.direction, itemstack);
