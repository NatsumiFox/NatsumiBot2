    ...
    private Entity a(Entity entity, boolean flag) {
        if (this.i() != null) {
            ...
            if (entity.world != null && flag) {
                SpawnerSpawnEvent spawnerspawnevent = CraftEventFactory.callSpawnerSpawnEvent(entity, this.b().getX(), this.b().getY(), this.b().getZ());

                if (!spawnerspawnevent.isCancelled()) {
                    entity.world.addEntity(entity, SpawnReason.SPAWNER);
            ...
            for (Entity entity1 = entity; nbttagcompound.hasKeyOfType("Riding", 10); nbttagcompound = nbttagcompound1) {
                ...
                if (entity2 != null) {
                    ...
                    SpawnerSpawnEvent spawnerspawnevent1 = CraftEventFactory.callSpawnerSpawnEvent(entity2, this.b().getX(), this.b().getY(), this.b().getZ());
                    ...
                    if (entity.world != null && flag) {
                        entity.world.addEntity(entity2, SpawnReason.SPAWNER);
                    }
