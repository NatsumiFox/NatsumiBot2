...
public class ServerStatisticManager extends StatisticManager {
    ...
    public ServerStatisticManager(MinecraftServer minecraftserver, File file) {
        ...
        this.d = file;
        Iterator iterator = SpigotConfig.forcedStats.keySet().iterator();
    ...
    public void setStatistic(EntityHuman entityhuman, Statistic statistic, int i) {
        if (!SpigotConfig.disableStatSaving) {
            ...
            if (statistic.d() && j == 0 && i > 0) {
                this.g = true;
                if (this.c.aB()) {
                    this.c.getPlayerList().sendMessage((IChatBaseComponent) (new ChatMessage("chat.type.achievement", new Object[] { entityhuman.getScoreboardDisplayName(), statistic.j()})));
                }
            }
            ...
            if (statistic.d() && j > 0 && i == 0) {
                this.g = true;
                if (this.c.aB()) {
                    this.c.getPlayerList().sendMessage((IChatBaseComponent) (new ChatMessage("chat.type.achievement.taken", new Object[] { entityhuman.getScoreboardDisplayName(), statistic.j()})));
                }
            }
