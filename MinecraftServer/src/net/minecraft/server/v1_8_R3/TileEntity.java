...
public abstract class TileEntity {
    ...
    public InventoryHolder getOwner() {
        if (this.world == null) {
            ...
            org.bukkit.block.Block org_bukkit_block_block = this.world.getWorld().getBlockAt(this.position.getX(), this.position.getY(), this.position.getZ());

            if (org_bukkit_block_block == null) {
                ...
                org.bukkit.block.BlockState org_bukkit_block_blockstate = org_bukkit_block_block.getState();

                return org_bukkit_block_blockstate instanceof InventoryHolder ? (InventoryHolder) org_bukkit_block_blockstate : null;
            }
        }
    }
}
