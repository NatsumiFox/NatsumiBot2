...
public class TileEntityHopper extends TileEntityContainer implements IHopper, IUpdatePlayerListBox {
            ...
            if (this.a(iinventory, enumdirection)) {
                ...
                for (int i = 0; i < this.getSize(); ++i) {
                    if (this.getItem(i) != null) {
                        ...
                        InventoryMoveItemEvent inventorymoveitemevent = new InventoryMoveItemEvent(this.getOwner().getInventory(), craftitemstack.clone(), (Inventory) object, true);
    ...
    private static boolean a(IHopper ihopper, IInventory iinventory, int i, EnumDirection enumdirection) {
        ...
        if (itemstack != null && b(iinventory, itemstack, i, enumdirection)) {
            ...
            CraftItemStack craftitemstack = CraftItemStack.asCraftMirror(iinventory.splitStack(i, ihopper.getWorld().spigotConfig.hopperAmount));
            Object object;
            ...
            InventoryMoveItemEvent inventorymoveitemevent = new InventoryMoveItemEvent((Inventory) object, craftitemstack.clone(), ihopper.getOwner().getInventory(), false);
            ...
            int j = inventorymoveitemevent.getItem().getAmount();
            ItemStack itemstack2 = addItem(ihopper, CraftItemStack.asNMSCopy(inventorymoveitemevent.getItem()), (EnumDirection) null);
            ...
            itemstack1.count -= j - itemstack2.count;
            iinventory.setItem(i, itemstack1);
        }
