...
public class UserCache {
    ...
    private void a(GameProfile gameprofile, Date date) {
        ...
        UserCache.UserCacheEntry usercache_usercacheentry = new UserCache.UserCacheEntry(gameprofile, date, (Object) null);
    ...
    public void c() {
        String s = this.b.toJson(this.a(SpigotConfig.userCacheCap));
    ...
    class BanEntrySerializer implements JsonDeserializer<UserCache.UserCacheEntry>, JsonSerializer<UserCache.UserCacheEntry> {
            ...
            if (jsonelement.isJsonObject()) {
                ...
                if (jsonelement1 != null && jsonelement2 != null) {
                    ...
                    if (s1 != null && s != null) {
                        ...
                        UserCache.UserCacheEntry usercache_usercacheentry = usercache.new UserCacheEntry(new GameProfile(uuid, s1), date, (Object) null);
        ...
        public JsonElement serialize(UserCache.UserCacheEntry usercache_usercacheentry, Type type, JsonSerializationContext jsonserializationcontext) {
            return this.a(usercache_usercacheentry, type, jsonserializationcontext);
        }
        ...
        public JsonElement serialize(Object object, Type type, JsonSerializationContext jsonserializationcontext) {
            return this.serialize((UserCache.UserCacheEntry) object, type, jsonserializationcontext);
        }
    }
