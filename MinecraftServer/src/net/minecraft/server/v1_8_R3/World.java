...
public abstract class World implements IBlockAccess {
    ...
    public ArrayList<org.bukkit.block.BlockState> capturedBlockStates = new ArrayList() {
        public boolean add(org.bukkit.block.BlockState org_bukkit_block_blockstate) {
            Iterator iterator = this.iterator();

            while (iterator.hasNext()) {
                org.bukkit.block.BlockState org_bukkit_block_blockstate1 = (org.bukkit.block.BlockState) iterator.next();

                if (org_bukkit_block_blockstate1.getLocation().equals(org_bukkit_block_blockstate.getLocation())) {
                    return false;
                }
            }

            return super.add(org_bukkit_block_blockstate);
        }

        public boolean add(Object object) {
            return this.add((org.bukkit.block.BlockState) object);
        }
    };
    ...
    public static long chunkToKey(int i, int j) {
        long k = ((long) i & 4294901760L) << 16 | ((long) i & 65535L) << 0;

        k |= ((long) j & 4294901760L) << 32 | ((long) j & 65535L) << 16;
        return k;
    }

    public static int keyToX(long i) {
        return (int) (i >> 16 & -65536L | i & 65535L);
    }

    public static int keyToZ(long i) {
        return (int) (i >> 32 & 4294901760L | i >> 16 & 65535L);
    }
    ...
    public Chunk getChunkIfLoaded(int i, int j) {
        return ((ChunkProviderServer) this.chunkProvider).getChunkIfLoaded(i, j);
    }

    protected World(IDataManager idatamanager, WorldData worlddata, WorldProvider worldprovider, MethodProfiler methodprofiler, boolean flag, ChunkGenerator chunkgenerator, Environment environment) {
    ...
    public boolean setTypeAndData(BlockPosition blockposition, IBlockData iblockdata, int i) {
        if (this.captureTreeGeneration) {
            Object object = null;
            Iterator iterator = this.capturedBlockStates.iterator();

            while (iterator.hasNext()) {
                org.bukkit.block.BlockState org_bukkit_block_blockstate = (org.bukkit.block.BlockState) iterator.next();

                if (org_bukkit_block_blockstate.getX() == blockposition.getX() && org_bukkit_block_blockstate.getY() == blockposition.getY() && org_bukkit_block_blockstate.getZ() == blockposition.getZ()) {
                    object = org_bukkit_block_blockstate;
                    iterator.remove();
                    break;
                }
            }
            ...
            if (object == null) {
                object = CraftBlockState.getBlockState(this, blockposition.getX(), blockposition.getY(), blockposition.getZ(), i);
            }

            ((org.bukkit.block.BlockState) object).setTypeId(CraftMagicNumbers.getId(iblockdata.getBlock()));
            ((org.bukkit.block.BlockState) object).setRawData((byte) iblockdata.getBlock().toLegacyData(iblockdata));
            this.capturedBlockStates.add(object);
            return true;
            ...
            if (iblockdata1 == null) {
                ...
                if (!this.captureBlockStates) {
                    this.notifyAndUpdatePhysics(blockposition, chunk, block1, block, i);
                }
    ...
    public void notifyAndUpdatePhysics(BlockPosition blockposition, Chunk chunk, Block block, Block block1, int i) {
        if ((i & 2) != 0 && (chunk == null || chunk.isReady())) {
            this.notify(blockposition);
        }

        if (!this.isClientSide && (i & 1) != 0) {
            this.update(blockposition, block);
            if (block1.isComplexRedstone()) {
                this.updateAdjacentComparators(blockposition, block1);
            }
        }
    ...
    public void d(BlockPosition blockposition, final Block block) {
        if (!this.isClientSide) {
            ...
            try {
                ...
                if (craftworld != null) {
                    BlockPhysicsEvent blockphysicsevent = new BlockPhysicsEvent(craftworld.getBlockAt(blockposition.getX(), blockposition.getY(), blockposition.getZ()), CraftMagicNumbers.getId(block));
    ...
    public IBlockData getType(BlockPosition blockposition) {
        return this.getType(blockposition, true);
    }

    public IBlockData getType(BlockPosition blockposition, boolean flag) {
        if (this.captureTreeGeneration && flag) {
            Iterator iterator = this.capturedBlockStates.iterator();
            ...
            while (iterator.hasNext()) {
                ...
                if (org_bukkit_block_blockstate.getX() == blockposition.getX() && org_bukkit_block_blockstate.getY() == blockposition.getY() && org_bukkit_block_blockstate.getZ() == blockposition.getZ()) {
                    return CraftMagicNumbers.getBlock(org_bukkit_block_blockstate.getTypeId()).fromLegacyData(org_bukkit_block_blockstate.getRawData());
                }
            }
        }
        ...
        if (!Double.isNaN(vec3d.a) && !Double.isNaN(vec3d.b) && !Double.isNaN(vec3d.c)) {
            if (!Double.isNaN(vec3d1.a) && !Double.isNaN(vec3d1.b) && !Double.isNaN(vec3d1.c)) {
                ...
                if ((!flag1 || block.a(this, blockposition, iblockdata) != null) && block.a(iblockdata, flag)) {
                    movingobjectposition = block.a(this, blockposition, vec3d, vec3d1);
                ...
                while (k1-- >= 0) {
                    ...
                    if (!flag1 || block1.a(this, blockposition, iblockdata1) != null) {
                        if (block1.a(iblockdata1, flag)) {
                            MovingObjectPosition movingobjectposition1 = block1.a(this, blockposition, vec3d, vec3d1);

                            if (movingobjectposition1 != null) {
                                return movingobjectposition1;
                            }
                        } else {
                            movingobjectposition = new MovingObjectPosition(MovingObjectPosition.EnumMovingObjectType.MISS, vec3d, enumdirection, blockposition);
                        }
                    }
                }
    ...
    public boolean addEntity(Entity entity, SpawnReason spawnreason) {
        ...
        if (entity == null) {
            ...
            if (entity instanceof EntityLiving && !(entity instanceof EntityPlayer)) {
                boolean flag1 = entity instanceof EntityAnimal || entity instanceof EntityWaterAnimal || entity instanceof EntityGolem;
                boolean flag2 = entity instanceof EntityMonster || entity instanceof EntityGhast || entity instanceof EntitySlime;

                if (spawnreason != SpawnReason.CUSTOM && (flag1 && !this.allowAnimals || flag2 && !this.allowMonsters)) {
                    entity.dead = true;
                    return false;
                }

                object = CraftEventFactory.callCreatureSpawnEvent((EntityLiving) entity, spawnreason);
            } else if (entity instanceof EntityItem) {
                object = CraftEventFactory.callItemSpawnEvent((EntityItem) entity);
            } else if (entity.getBukkitEntity() instanceof Projectile) {
                object = CraftEventFactory.callProjectileLaunchEvent(entity);
            } else if (entity instanceof EntityExperienceOrb) {
                EntityExperienceOrb entityexperienceorb = (EntityExperienceOrb) entity;
                double d0 = this.spigotConfig.expMerge;

                if (d0 > 0.0D) {
                    List list = this.getEntities(entity, entity.getBoundingBox().grow(d0, d0, d0));
                    Iterator iterator = list.iterator();

                    while (iterator.hasNext()) {
                        Entity entity1 = (Entity) iterator.next();

                        if (entity1 instanceof EntityExperienceOrb) {
                            EntityExperienceOrb entityexperienceorb1 = (EntityExperienceOrb) entity1;
            ...
            if (object != null && (((Cancellable) object).isCancelled() || entity.dead)) {
                entity.dead = true;
                return false;
            } else if (!flag && !this.isChunkLoaded(i, j, true)) {
                entity.dead = true;
                return false;
            } else {
                if (entity instanceof EntityHuman) {
    ...
    public void kill(Entity entity) {
        ...
        if (entity instanceof EntityHuman) {
            ...
            Iterator iterator = this.worldMaps.c.iterator();
            ...
            while (iterator.hasNext()) {
                ...
                if (object instanceof WorldMap) {
                    ...
                    worldmap.i.remove(entity);
                    Iterator iterator1 = worldmap.g.iterator();

                    while (iterator1.hasNext()) {
                        if (((WorldMap.WorldMapHumanTracker) iterator1.next()).trackee == entity) {
                            iterator1.remove();
                        }
                    }
                }
    ...
    public void removeEntity(Entity entity) {
        ...
        if (!this.guardEntityList) {
            ...
            int k = this.entityList.indexOf(entity);
    ...
    public List<AxisAlignedBB> getCubes(Entity entity, AxisAlignedBB axisalignedbb) {
        ...
        for (int i2 = i >> 4; i2 <= j - 1 >> 4; ++i2) {
            int j2 = i2 << 4;

            for (int k2 = i1 >> 4; k2 <= j1 - 1 >> 4; ++k2) {
                if (this.isChunkLoaded(i2, k2, true)) {
                    l1 = k2 << 4;
                    Chunk chunk = this.getChunkAt(i2, k2);
                    int l2 = i < j2 ? j2 : i;
                    int i3 = j < j2 + 16 ? j : j2 + 16;
                    int j3 = i1 < l1 ? l1 : i1;
                    int k3 = j1 < l1 + 16 ? j1 : l1 + 16;
        ...
        for (l1 = 0; l1 < list.size(); ++l1) {
            if (entity.passenger != list && entity.vehicle != list) {
                AxisAlignedBB axisalignedbb1 = ((Entity) list.get(l1)).S();

                if (axisalignedbb1 != null && axisalignedbb1.b(axisalignedbb)) {
                    arraylist.add(axisalignedbb1);
                }

                axisalignedbb1 = entity.j((Entity) list.get(l1));
                if (axisalignedbb1 != null && axisalignedbb1.b(axisalignedbb)) {
                    arraylist.add(axisalignedbb1);
                }
            }
    ...
    public void tickEntities() {
        ...
        if (!this.b.isEmpty()) {
            for (int j1 = 0; j1 < this.b.size(); ++j1) {
                TileEntity tileentity1 = (TileEntity) this.b.get(j1);
    ...
    public void entityJoinedWorld(Entity entity, boolean flag) {
        ...
        if (!ActivationRange.checkIfActive(entity)) {
            ...
            if (!entity.ad || entity.ae != i || entity.af != j || entity.ag != k) {
    ...
    protected void D() {
        ...
        if (i > 0 && !this.players.isEmpty()) {
            ...
            for (l = 0; l < this.players.size(); ++l) {
                entityhuman = (EntityHuman) this.players.get(l);
                i1 = MathHelper.floor(entityhuman.locX / 16.0D);
                j1 = MathHelper.floor(entityhuman.locZ / 16.0D);
                k1 = this.q();
            ...
            if (this.spigotConfig.randomLightUpdates && !this.players.isEmpty()) {
                l = this.random.nextInt(this.players.size());
                entityhuman = (EntityHuman) this.players.get(l);
                i1 = MathHelper.floor(entityhuman.locX) + this.random.nextInt(11) - 5;
                j1 = MathHelper.floor(entityhuman.locY) + this.random.nextInt(11) - 5;
                k1 = MathHelper.floor(entityhuman.locZ) + this.random.nextInt(11) - 5;
                this.x(new BlockPosition(i1, j1, k1));
            }
    ...
    public List<Entity> a(Entity entity, AxisAlignedBB axisalignedbb, Predicate<? super Entity> predicate) {
        ...
        if (j - i <= 10 && l - k <= 10) {
            ...
            this.getServer().getLogger().log(Level.WARNING, "Filtered out large getEntities call {0},{1} {2},{3}", new Object[] { Integer.valueOf(i), Integer.valueOf(j), Integer.valueOf(k), Integer.valueOf(j)});
            return arraylist;
        }
    }
    ...
    public boolean a(Block block, BlockPosition blockposition, boolean flag, EnumDirection enumdirection, Entity entity, ItemStack itemstack) {
        ...
        boolean flag1 = axisalignedbb != null && !this.a(axisalignedbb, entity) ? false : (block1.getMaterial() == Material.ORIENTABLE && block == Blocks.ANVIL ? true : block1.getMaterial().isReplaceable() && block.canPlace(this, blockposition, enumdirection, itemstack));
        BlockCanBuildEvent blockcanbuildevent = new BlockCanBuildEvent(this.getWorld().getBlockAt(blockposition.getX(), blockposition.getY(), blockposition.getZ()), CraftMagicNumbers.getId(block), flag1);
