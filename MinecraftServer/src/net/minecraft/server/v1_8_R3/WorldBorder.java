...
public class WorldBorder {
    ...
    public boolean isInBounds(ChunkCoordIntPair chunkcoordintpair) {
        return this.isInBounds(chunkcoordintpair.x, chunkcoordintpair.z);
    }

    public boolean isInBounds(long i) {
        return this.isInBounds(LongHash.msw(i), LongHash.lsw(i));
    }

    public boolean isInBounds(int i, int j) {
        return (double) ((i << 4) + 15) > this.b() && (double) (i << 4) < this.d() && (double) ((j << 4) + 15) > this.c() && (double) (i << 4) < this.e();
    }
