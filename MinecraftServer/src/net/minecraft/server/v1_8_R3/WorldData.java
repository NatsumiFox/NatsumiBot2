...
public class WorldData {
    ...
    public void setThundering(boolean flag) {
        org.bukkit.World org_bukkit_world = Bukkit.getWorld(this.getName());

        if (org_bukkit_world != null) {
            ThunderChangeEvent thunderchangeevent = new ThunderChangeEvent(org_bukkit_world, flag);
    ...
    public void setStorm(boolean flag) {
        ...
        if (org_bukkit_world != null) {
            WeatherChangeEvent weatherchangeevent = new WeatherChangeEvent(org_bukkit_world, flag);
