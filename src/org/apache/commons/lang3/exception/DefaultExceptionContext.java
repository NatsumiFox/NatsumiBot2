...
public class DefaultExceptionContext implements ExceptionContext, Serializable {
    ...
    private final List<org.apache.commons.lang3.tuple.Pair<String, Object>> contextValues = new ArrayList<org.apache.commons.lang3.tuple.Pair<String,Object>>();
    ...
    public DefaultExceptionContext setContextValue(final String label, final Object value) {
        for (final Iterator<org.apache.commons.lang3.tuple.Pair<String, Object>> iter = contextValues.iterator(); iter.hasNext();) {
            final org.apache.commons.lang3.tuple.Pair<String, Object> p = iter.next();
    ...
    public List<Object> getContextValues(final String label) {
        ...
        for (final org.apache.commons.lang3.tuple.Pair<String, Object> pair : contextValues) {
     ...
     */
    @Override
    public List<org.apache.commons.lang3.tuple.Pair<String, Object>> getContextEntries() {
