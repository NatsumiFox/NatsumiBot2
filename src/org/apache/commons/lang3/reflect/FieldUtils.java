...
public class FieldUtils {
    ...
    public static Field getField(final Class<?> cls, final String fieldName, final boolean forceAccess) {
        ...
        for (final Class<?> class1 : ClassUtils.getAllInterfaces(cls)) {
            try {
                ...
                org.apache.commons.lang3.Validate.isTrue(match == null, "Reference to field %s is ambiguous relative to %s"
    ...
    public static Object readStaticField(final Field field, final boolean forceAccess) throws IllegalAccessException {
        ...
        org.apache.commons.lang3.Validate.isTrue(Modifier.isStatic(field.getModifiers()), "The field '%s' is not static", field.getName());
    ...
    public static void writeStaticField(final Field field, final Object value, final boolean forceAccess) throws IllegalAccessException {
        org.apache.commons.lang3.Validate.isTrue(field != null, "The field must not be null");
        org.apache.commons.lang3.Validate.isTrue(Modifier.isStatic(field.getModifiers()), "The field %s.%s is not static", field.getDeclaringClass().getName(),
                field.getName());
