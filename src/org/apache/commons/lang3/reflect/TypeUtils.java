...
public class TypeUtils {
    ...
    public static final ParameterizedType parameterizeWithOwner(final Type owner, final Class<?> raw,
        ...
        if (raw.getEnclosingClass() == null) {
            ...
            org.apache.commons.lang3.Validate.isTrue(TypeUtils.isAssignable(owner, raw.getEnclosingClass()),
        ...
        org.apache.commons.lang3.Validate.isTrue(raw.getTypeParameters().length == typeArguments.length,
    ...
    private static Type[] extractTypeArgumentsFrom(final Map<TypeVariable<?>, Type> mappings, final TypeVariable<?>[] variables) {
        ...
        for (final TypeVariable<?> var : variables) {
            org.apache.commons.lang3.Validate.isTrue(mappings.containsKey(var), "missing argument mapping for %s", toString(var));
    ...
    public static GenericArrayType genericArrayType(final Type componentType) {
        return new GenericArrayTypeImpl(org.apache.commons.lang3.Validate.notNull(componentType, "componentType is null"));
    }
    ...
    public static String toString(final Type type) {
        ...
        throw new IllegalArgumentException(org.apache.commons.lang3.ObjectUtils.identityToString(type));
    }
