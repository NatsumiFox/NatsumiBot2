...
public class DurationFormatUtils {
    ...
    public static String formatDuration(final long durationMillis, final String format, final boolean padWithZeros) {
        org.apache.commons.lang3.Validate.inclusiveBetween(0, Long.MAX_VALUE, durationMillis, "durationMillis must not be negative");
    ...
    public static String formatDurationWords(
        ...
        if (suppressLeadingZeroElements) {
            ...
            duration = " " + duration;
            String tmp = org.apache.commons.lang3.StringUtils.replaceOnce(duration, " 0 days", "");
        ...
        if (suppressTrailingZeroElements) {
            String tmp = org.apache.commons.lang3.StringUtils.replaceOnce(duration, " 0 seconds", "");
            if (tmp.length() != duration.length()) {
                duration = tmp;
                tmp = org.apache.commons.lang3.StringUtils.replaceOnce(duration, " 0 minutes", "");
                if (tmp.length() != duration.length()) {
